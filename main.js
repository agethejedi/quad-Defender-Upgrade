...
const hullMat  = mat(0x3a5070, 0.3, 0.75)
const hull2Mat = mat(0x2a3d58, 0.35, 0.7)
const darkMat  = mat(0x1a2840, 0.5, 0.55)
const blueMat  = new THREE.MeshStandardMaterial({ color: 0x1a7fff, emissive: 0x0066ff, emissiveIntensity: 2.8 })
const redMat   = new THREE.MeshStandardMaterial({ color: 0xff5555, emissive: 0xff1020, emissiveIntensity: 5.0 })
const orangeMat= new THREE.MeshStandardMaterial({ color: 0xff8833, emissive: 0xff5500, emissiveIntensity: 4.5 })
...
// Core light
const coreLight = new THREE.PointLight(0xff2030, isBoss ? 6.0 : 4.0, isBoss ? 18 : 10)
